...
<head>
    <meta charset="utf-8">
    <title>Webhook Payments Report</title>
    <style>
        body {
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">BDT {{ number_format($item->amount, 2) }}</td>
    ...
    <div class="footer">
        ...
        <p>ISP Billing System - Webhook Payments Report</p>
    </div>
</body>
</html>
